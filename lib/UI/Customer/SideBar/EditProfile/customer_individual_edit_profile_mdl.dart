...
CustomerIndividualEditProfileMdl customerEditProfileMdlFromJson(String str) => CustomerIndividualEditProfileMdl.fromJson(json.decode(str));

String customerEditProfileMdlToJson(CustomerIndividualEditProfileMdl data) => json.encode(data.toJson());

class CustomerIndividualEditProfileMdl {
  CustomerIndividualEditProfileMdl({
    required this.data,
  ...
  factory CustomerIndividualEditProfileMdl.fromJson(Map<String, dynamic> json) => CustomerIndividualEditProfileMdl(
