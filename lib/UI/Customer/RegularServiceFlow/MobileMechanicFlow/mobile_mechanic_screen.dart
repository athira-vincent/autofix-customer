...
class MobileMechanicScreen extends StatefulWidget {

  MobileMechanicScreen();

  @override
  State<StatefulWidget> createState() {
    return _MobileMechanicScreenState();
  }
}

class _MobileMechanicScreenState extends State<MobileMechanicScreen> {
  @override
