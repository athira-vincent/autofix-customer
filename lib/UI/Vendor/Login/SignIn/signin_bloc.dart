...
class VendorSigninBloc {
  final Repository repository = Repository();
  final postSignIn = PublishSubject<VendorSigninMdl>();
  Stream<VendorSigninMdl> get signInResponse => postSignIn.stream;
  dispose() {
    postSignIn.close();
  }

  postSignInRequest(String userName, String password) async {
    VendorSigninMdl _signInMdl = await repository.getSignIn(userName, password);
