...
import 'package:auto_fix/UI/Vendor/Login/SignIn/signin_screen.dart';
import 'package:auto_fix/UI/Vendor/Login/SignUp/signup_bloc.dart';
...
class VendorSignupScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _VendorSignupScreenState();
  }
}
...
class _VendorSignupScreenState extends State<VendorSignupScreen> {
  ...
  final VendorSignupBloc _signupBloc = VendorSignupBloc();
                ...
                InkWell(
                  onTap: () {
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => VendorSigninScreen()));
                  },
                  child: Container(
