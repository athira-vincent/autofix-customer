...
class CustomerTrackScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _CustomerTrackScreenState();
  }
}
...
class _CustomerTrackScreenState extends State<CustomerTrackScreen> {
  ...
  _getGeoLocationPosition() async {
    ...
    print('serviceEnabled ++++++   03a ' + serviceEnabled.toString());
    if (!serviceEnabled) {
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child:  InkWell(
                                onTap: (){
                                  //print("""athira 01 >>>> $mechanicCurrentLat, $mechanicCurrentLng, ${double.parse('${widget.latitude}')}, ${double.parse('${widget.longitude}')}""");
