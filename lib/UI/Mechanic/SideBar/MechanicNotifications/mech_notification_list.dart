...
import 'package:auto_fix/UI/Mechanic/SideBar/MechanicNotifications/mech_notification_bloc.dart';
...
class MechanicNotificationList extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _MechanicNotificationList();
  }
}

class _MechanicNotificationList extends State<MechanicNotificationList> {
  static const routeName = '/mechNotificationList';
  @override
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) =>
              VendornotificationBloc()..add(FetchVendornotificationEvent()),
        ),
      ],
      child: Scaffold(
          appBar: AppBar(
              ...
              child: Stack(
                children: [
                  ...
                  Padding(
                    ...
                    child: BlocBuilder<VendornotificationBloc,
                        VendornotificationState>(builder: (context, state) {
                      ...
                      } else if (state is VendornotificationErrorState) {
