  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    ...
    return SynchronousFuture<MaterialLocalizations>(
      IgMaterialLocalizations(
        ...
        shortMonthDayFormat: intl.DateFormat('MMM d',"ig"),
      ),
    );
  }
...
/// A custom set of localizations for the 'ig' locale. In this example, only
...
class IgMaterialLocalizations extends GlobalMaterialLocalizations {
  const IgMaterialLocalizations({
    localeName = 'ig',
    required fullYearFormat,
    required compactDateFormat,
    required shortDateFormat,
    required mediumDateFormat,
    required longDateFormat,
    required yearMonthFormat,
    required shortMonthDayFormat,
    required decimalFormat,
    required twoDigitZeroPaddedFormat,
  }) : super(localeName: 'ig',
      fullYearFormat: fullYearFormat,
      compactDateFormat: compactDateFormat,
      shortDateFormat: shortDateFormat,
      mediumDateFormat: mediumDateFormat, longDateFormat: longDateFormat,
      yearMonthFormat: yearMonthFormat, shortMonthDayFormat: shortMonthDayFormat,
      decimalFormat: decimalFormat, twoDigitZeroPaddedFormat: twoDigitZeroPaddedFormat);
