...
class MechTakeVehicleTrackScreen01 extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return _MechTakeVehicleTrackScreen01();
  }

}

class _MechTakeVehicleTrackScreen01 extends State <MechTakeVehicleTrackScreen01>{
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('customer reached service center',
                        style: TextStyle(
                          fontSize: 12,
                          fontFamily: 'SamsungSharpSans-Medium',
                        ),),
